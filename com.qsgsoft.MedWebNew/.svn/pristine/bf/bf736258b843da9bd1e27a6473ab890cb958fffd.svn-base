					...
					if ((!childwindow1.contains(mainwindow))
						...
						while (itr3.hasNext()) {
							...
							if (!(cw.contains(mainwindow))
								...
								Thread.sleep(3000);
								objViewPatients
										.verValueOfTagNameIsDisplayed(objViewPatients_data.strPersonalPhrase)
										.verValueOfTagNameIsDisplayed(objViewPatients_data.strPersonalPhrase1)
										.verValueOfTagNameIsDisplayed(objViewPatients_data.strPersonalPhrase2);
							}
						}
