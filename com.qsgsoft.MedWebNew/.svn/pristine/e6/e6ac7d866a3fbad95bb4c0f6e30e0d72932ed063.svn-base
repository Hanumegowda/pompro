...
public class HappyDayRetainStudyStatStatusOption extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay29961() throws Exception {
		...
		objViewPatients.clickOnSearch1()
				.clickOnChangeStatStatusOfStudy();
	...
	**************************************************************************************/
	...
	public void testHappyDay29965() throws Exception {
		...
		driver.switchTo().window(mainwindow);
		objViewPatients.clickOnViewModifyWebReportsOfAStudy(objViewPatients_data.strStudy);
		...
		driver.switchTo().window(mainwindow);
		objViewPatients.clickOnSearch().verStatStatus(
