package rh4CommercialServer.requirementGroup.smokeSuit.ControlPanelAccessRights;
	...
	**************************************************************************************/
	...
	public void testHappyDay68251() throws Exception {
		...
		objAddUser.enterFullNameLast(objUser_data.strModNewUserName)
				...
				.clickOnSaveChanges();
		objUserManagement.enterTextInUserNameSearchField(objUser_data.strModNewUserName).clickOnSearch()
				.verifyUserWithRedBallandUserNeverLoggedIn(objUser_data.strModNewUserName);
		objUserManagement.clickOnRemoveUser(objUser_data.strNewUserName)
				.clickOnOkInAlertPopUp();
		Thread.sleep(3000);
		objUserManagement
				.enterTextInUserNameSearchField(objUser_data.strModNewUserName)
	...
	**************************************************************************************/
	...
	public void testHappyDay68259() throws Exception {
		...
		objAddUser.verAddNewUserPage()
				...
				.clickOnSaveChanges();
		System.out.println(objUser_data.strNewUserName);
		objUserManagement.enterTextInUserNameSearchField(objUser_data.strNewUserName1).clickOnSearch()
	...
	**************************************************************************************/
	...
	public void testHappyDay68266() throws Exception {
		...
		objUserManagement.clickOnRemoveUser(objUser_data.strNewUserName1)
				.clickOnOkInAlertPopUp();
		Thread.sleep(5000);
		objUserManagement.enterTextInUserNameSearchField(objUser_data.strNewUserName1).clickOnSearch().verUserNotFoundErrMsg();
	...
	**************************************************************************************/
	...
	public void testHappyDay68261() throws Exception {
		...
		objUserManagement
				...
				.clickOnSearch()
				.verifyUserWithRedBallandUserNeverLoggedIn(
						objUser_data.strModNewUserName);
		objHome.clickOnLogOut();
	...
	**************************************************************************************/
	...
	public void testHappyDay68271() throws Exception {
		...
		objLogin.verifyLoginPageIsDisplaying()
				.login(objLogin_data.strAdminUser, objLogin_data.strAdminUserPwd)
				.clickLogin();
		objHome.verHomePage().clickOnAdminSite();
		objLogin.login(objLogin_data.strAdminUser, objLogin_data.strAdminUserPwd)
				.clickLogin();
		objNavigationToSubMenus.clickOnControlPanel();
		objControlPanel.clickOnAccessRights()
