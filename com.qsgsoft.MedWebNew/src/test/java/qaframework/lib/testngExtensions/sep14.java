...
public class sep14 {
	...
	// For IE browser
	public void setUp(String browserr) throws Exception {
		if (browserr.equalsIgnoreCase("ie")) {
		...
		// For Chrome browser
		else if( browserr.equalsIgnoreCase("chrome")) {
			DesiredCapabilities cap = new DesiredCapabilities();
			cap.setJavascriptEnabled(true);
