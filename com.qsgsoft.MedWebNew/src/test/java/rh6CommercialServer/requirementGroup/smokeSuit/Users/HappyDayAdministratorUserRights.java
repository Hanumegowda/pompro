...
public class HappyDayAdministratorUserRights extends
	...
	**************************************************************************************/
	...
	public void testHappyDay67958() throws Exception {
		...
		try {
			...
			System.out.println("");
			objUserManagement.verUserWithACLGroupIsNotPresent(objUser_data.strNewUserName1, objUser_data.radioLogist);
		}
	...
	**************************************************************************************/
	...
	public void testHappyDay165611() throws Exception {
		...
		try {
			objUserManagement.enterTextInUserNameSearchField(
					objUser_data.csvuser2[0]).clickOnSearch();
			objUserManagement.verUserNotFoundErrMsg();
		} catch (NoSuchElementException e) {
			System.out.println("");
			objUserManagement.verUserWithACLGroupIsNotPresent(objUser_data.csvuser2[0], objUser_data.csvuser2[5]);
		}
