...
public class HappyDayLocalSettings extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay100685() throws Exception {
		...
		objDICOMSetting.clickOnAliasesLinkOfAeTitle()
				...
				.selProxyQRRequestsToCheckBox().selRaq49ServerCheckBox()
				.clickOnSaveChanges();
		Thread.sleep(5000);
	...
	public void testHappyDay68316() throws Exception {
		...
		while (itr2.hasNext()) {
			...
			if (!childwindow.contains(mainWindow)) {
				 ...
				 * System.out.println(wintitle + " this is window title"); if
				 * (wintitle.equals("Enter Login and Password")) {
				 * objLogin.login(objLogin_data.strAdminUser,
				 * objLogin_data.strAdminUserPwd).clickLogin(); } String
				 * wintitle1 = driver.getWindowHandle(); if
				 * (wintitle1.equals("Enter Login and Password")) {
				 * objLogin.login(objLogin_data.strAdminUser,
				 * objLogin_data.strAdminUserPwd).clickLogin(); }
				 */
		...
		objViewPatients.clickOnSearch().clickOnSearch().clickOnSearch();
		Thread.sleep(3000);
		objViewPatients.clickOnSearch().clickOnSearch().clickOnSearch().clickOnSearch().clickOnSearch();
		objHome.launchApplication(objLogin_data.strAppURL);
		objHome.clickOnViewPatients();
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
	...
	**************************************************************************************/
	...
	public void testHappyDay68321() throws Exception {
		...
		objAdministratorSite.verAdministratorSitePage().verUserManagementPage();
		objNavigationToSubMenus.clickOnDICOMSettings();
		objDICOMSetting.selHTMLReportEditorCheckBox().deSelExpressTranscriptionCheckBox().clickOnSaveChanges();
		objNavigationToSubMenus.clickOnPublicSite();
		objHome.clickOnViewPatients();
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
		...
		/*
		 * driver.switchTo().window(mainwindow); objHome.clickOnAdminSite();
		 * objNavigationToSubMenus.clickOnDICOMSettings();
		 * objDICOMSetting.deSelHTMLReportEditorCheckBox();
		 * objAddUser.clickOnSaveChanges();
		 * objNavigationToSubMenus.clickOnPublicSite();
		 * objHome.clickOnViewPatients(); objViewPatients.clickOnSearch();
		 * objViewPatients.clickOnViewOrModifyIcon(); String mainwindow1 =
		 * driver.getWindowHandle(); String childwindow1 = ""; Set<String> all2
		 * = driver.getWindowHandles(); Iterator<String> itr2 = all2.iterator();
		 * while (itr2.hasNext()) { childwindow1 = itr2.next().toString(); if
		 * (!childwindow1.contains(mainwindow1)) {
		 * driver.switchTo().window(childwindow1);
		 * objViewPatients.clickOnAddButton(); } }
		 * 
		 * Set<String> all3 = driver.getWindowHandles(); Iterator<String> itr3 =
		 * all3.iterator(); while (itr3.hasNext()) { String childwindow2 =
		 * itr3.next().toString(); if (!childwindow2.contains(mainwindow1) &&
		 * (!childwindow2.contains(childwindow1))) {
		 * driver.switchTo().window(childwindow2);
		 * objViewPatients.verRadiologyReportPageIsDisplayed();
		 * 
		 * } }
		 */
		gstrResult = "PASS";
...
Thread.sleep(3000);
		...
		objViewPatients
				.enterTextInFind(objViewPatients_data.strStudy)
				.clickOnSearch()
				.clickOnSearch().selLayout(objViewPatients_data.strLayout)
	...
	**************************************************************************************/
	...
	public void testHappyDay68324() throws Exception {
		...
		objAdministratorSite.verAdministratorSitePage().verUserManagementPage();
		objNavigationToSubMenus.clickOnDICOMSettings();
		objDICOMSetting.selAddDigitalSignatureBlockCheckBox().selHTMLReportEditorCheckBox()
		.deSelExpressTranscriptionCheckBox().clickOnSaveChanges();
		objNavigationToSubMenus.clickOnPublicSite();
		objHome.clickOnViewPatients();
		objLogin.loginAsUser(objLogin_data.strAdminUser,
	...
	**************************************************************************************/
	...
	public void testHappyDay167035() throws Exception {
		...
		objViewPatients.selInLastOption(objDICOMSettings_data.hour).enterTextInFind(objViewPatients_data.strStudy)
				.clickOnSearch1();
		objViewPatients.clickOnSendThisStudyToDICOMStorageDevice(objViewPatients_data.strStudy);
		...
		objViewPatients.selInLastOption(objDICOMSettings_data.hour).enterTextInFind(objViewPatients_data.strStudy)
				.clickOnSearch().clickOnSearch().clickOnSearch();
		objViewPatients.clickOnModifyStudyFieldsOfAStudy(objViewPatients_data.strStudy);
		Set<String> all2 = driver.getWindowHandles();
		Iterator<String> itr2 = all2.iterator();
		while (itr2.hasNext()) {
			String childwindow2 = itr2.next().toString();
			if (!childwindow2.contains(mainwindow)) {
				...
				objModifyStudy.getTextInMTFFieldAndVer(objDICOMSettings_data.mtfcode);
	...
	**************************************************************************************/
	...
	public void testHappyDay68342() throws Exception {
		...
		for (int i = 0; i < 2; i++) {
			...
			objViewPatients.clickOnSearch().clickOnSearch().clickOnSearch().clickOnSearch().clickOnSearch()
					.clickOnSearch().clickOnSearch()
					.clickOnModifyStudyIconOfAStudy(str[i]);
			String mainwindow = driver.getWindowHandle();
			Set<String> allwindows = driver.getWindowHandles();
			Iterator<String> itr = allwindows.iterator();
			while (itr.hasNext()) {
			...
			driver.switchTo().window(mainwindow);
			objViewPatients.selStatusOption(objViewPatients_data.strStatus).clickOnSearch()
					.clickOnSearch();
		}
		objViewPatients.selStatusOption(objViewPatients_data.strStatus)
				.selInLastOption(objDICOMSettings_data.hour)
		...
		objViewPatients.selStatusOption(objViewPatients_data.strStatus).clickOnSearch().clickOnSearch().verNoStudiesAvailableErrorMessage();
