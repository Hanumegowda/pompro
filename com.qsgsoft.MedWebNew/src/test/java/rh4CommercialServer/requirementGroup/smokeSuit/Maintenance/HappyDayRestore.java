...
public class HappyDayRestore extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay68296() throws Exception {
		...
		objMaintenance.verBackUpFileFromRemoteServers(date,"");
	...
	**************************************************************************************/
	...
	public void testHappyDay68286() throws Exception {
		...
		String autoit = pathProps.getProperty(objPathData./*autoItFilePath2*/strAutoITPath);
		...
		Thread.sleep(5000);
		/*String arg[] = {autoitfilepath,backupfiledownloadpath1};
		Runtime.getRuntime().exec(arg);
		Thread.sleep(10000);*/
		 
		
		objAutoIT.DownloadTheReports1(autoitfilepath, backupfiledownloadpath1,"Marr.exe");
		Thread.sleep(10000);
		...
		objNavigationToSubMenus.clickOnMaintenance();
		objMaintenance.clickOnRestoreButton()
				.clickOnBrowseButton(backupfiledownloadpath1 + ".qub");
				objMaintenance.clickOnRestoreBackUpFileButton().clickOnRestoreBackUpFileButton();
		objUserManagement.clickOnOkInAlertPopUp();
		Thread.sleep(10000);
		objNavigationToSubMenus.clickOnUser();
		objUserManagement
