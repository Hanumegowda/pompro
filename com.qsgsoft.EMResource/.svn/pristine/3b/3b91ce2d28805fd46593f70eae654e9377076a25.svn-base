...
public class FileFormatConverter {
    ...
    public void convertXlsxToXls(String strIp, String outFn) throws InvalidFormatException,IOException {
    	
        try {
            XSSFWorkbook wbIn = new XSSFWorkbook(new FileInputStream(strIp));
