...
public class Configuration_Mails extends ConfigSetting {

	public Configuration_Mails() throws Exception {
	...
	public void setUpMethod() throws Exception {
		...
		this.driver1.manage().timeouts().implicitlyWait(WaitTimeConstants.WAIT_TIME_LONG, TimeUnit.SECONDS);
		this.driver1.manage().timeouts().pageLoadTimeout(WaitTimeConstants.WAIT_TIME_LONG, TimeUnit.SECONDS);
		
		this.driver1.get("http://www.outlook.com");
