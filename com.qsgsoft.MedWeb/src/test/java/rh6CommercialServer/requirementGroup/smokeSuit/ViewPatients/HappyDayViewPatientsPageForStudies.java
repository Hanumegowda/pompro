...
public class HappyDayViewPatientsPageForStudies extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	public void testHappyDay128721() throws Exception {
		...
		objGroups.clickOnAddGroup().enterGroupName(objGroups_data.groupname)
				...
				.clickOnCopy().selectShowUploadZipFilesCheckBox()
				.clickOnSaveChanges();
		...
		objViewPatients.enterTextInFind(substr).clickOnSearch().clickOnSearch()
				.clickOnSearch();
		...
		objViewPatients.selInLastOption(objDICOMSettings_data.hour)
				.enterTextInFind(substr).clickOnSearch().clickOnSearch()
				.clickOnSearch().clickOnSearch().clickOnSearch()
				.verUploadZipFile1(filenamea[0]).verUploadZipFile1(filenameb[0])
				.verUploadZipFile1(filenamec[0]).verUploadZipFile1(filenamed[0])
				.verUploadZipFile1(filenamee[0]);
	...
	**************************************************************************************/
	...
	public void testHappyDay68394() throws Exception {
		...
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
		objViewPatients.verNewStudyLinkIsDisplayed()
				.verAStudyColumnHeadersIsDisplayed();
		objViewPatients.clickOnLogout();
