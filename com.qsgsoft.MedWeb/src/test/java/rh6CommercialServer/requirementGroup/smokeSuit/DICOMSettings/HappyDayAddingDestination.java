...
public class HappyDayAddingDestination extends TestNG_UI_EXTENSIONSForOneBrowser{
		...
		while (itr.hasNext()) {
			...
			if (!childwindow.contains(mainWindow)) {
				...
				objViewPatients
						...
						.clickOnNextInSendStudyWizard()
						.selStorageDevice(
								objDICOMSettings_data.storageDeviceFtp93)
						.clickOnFinishButton();
				Thread.sleep(3000);
				objViewPatients.clickOnFinishButton();
			}
		...
		while (itr.hasNext()) {
			...
			if (!childwindow.contains(mainWindow)) {
				...
				objViewPatients
						...
						.clickOnNextInSendStudyWizard()
						.selStorageDevice(
								objDICOMSettings_data.storageDeviceForDICOMOverSecureTunnelProtocol93)
						.clickOnFinishButton();
				Thread.sleep(3000);
				objViewPatients.clickOnFinishButton();
			}
	...
	**************************************************************************************/
	...
	public void testHappyDay128694() throws Exception {
		...
		objDestinations.clickOnSaveChanges();
		objDestinations
				.verAddedDestination(objDICOMSettings_data.aETitle2,
						objDICOMSettings_data.ipAddress1,
						objDICOMSettings_data.dICOMIPPort,
						objDICOMSettings_data.label1);
