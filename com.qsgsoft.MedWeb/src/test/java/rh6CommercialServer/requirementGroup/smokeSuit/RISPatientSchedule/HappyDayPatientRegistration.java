	...
	**************************************************************************************/
	...
	public void testHappyDay62719() throws Exception {
		...
		objPatientScheduleRegistration
				...
				.enterTextInBusinessPhone(
						objPatientSchedule_data.strBuisinessPhone)
				.enterTextInVeteransMilitaryStatus(
						objPatientSchedule_data.strVeteransMilitaryStatus)
				.enterTextInAllergyType(objPatientSchedule_data.strAllergyType)
				.enterTextInSeverity(objPatientSchedule_data.strSeverity)
				.enterTextInCodeOrDescription(
						objPatientSchedule_data.strDescription)
	...
	**************************************************************************************/
	...
	public void testHappyDay68441() throws Exception {
		...
		if (bn.equalsIgnoreCase("MicrosoftEdge")) {
			...
			objHome.clickOnLogOut92()/* .clickOnLogout() */;
			Thread.sleep(5000);
			objHome.launchApplication(objLogin_data.strAppURL1);
