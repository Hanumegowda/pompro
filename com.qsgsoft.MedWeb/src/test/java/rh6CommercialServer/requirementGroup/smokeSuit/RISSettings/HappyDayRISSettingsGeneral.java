package rh6CommercialServer.requirementGroup.smokeSuit.RISSettings;
...
public class HappyDayRISSettingsGeneral extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay68182() throws Exception {
		...
		objRISSettings.clickOnOpenPageOfGeneralRISSettings()
				.enterTextInPatientIDPrefix(str).clickOnSaveChanges();
		objNavigationToSubMenus.clickOnPublicSite();
		objHome.clickOnPatientSchedule();
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
		objPatientScheduleRegistration.verPatientIdPrefix(str).clickOnLogOut();
