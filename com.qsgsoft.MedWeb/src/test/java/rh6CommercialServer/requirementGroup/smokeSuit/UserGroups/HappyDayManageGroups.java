	...
	**************************************************************************************/
	...
	public void testHappyDay122285() throws Exception {
		...
		objUserManagement.verUserWithACLGroup(objUser_data.strNewUserName1,
				objUser_data.radioLogist).clickOnModifyUser(
		...
		objUserManagement.verUserWithACLGroupIsNotPresent(
				objUser_data.strNewUserName1, objUser_data.generalist);
		...
		objAddUser.clickOnSaveChanges();
		objGroups.verGroupNameInGroupList(objGroups_data.groupnamemod)
				.deleteGroup(objGroups_data.groupnamemod);
		objUserManagement.clickOnOkInAlertPopUp();
		Thread.sleep(5000);
		objGroups
				.verGroupNameIsNotDisplayingInGroupList(objGroups_data.groupnamemod);
