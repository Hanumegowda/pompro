	...
	**************************************************************************************/
	...
	public void testHappyDay164191() throws Exception {
		...
		objUserManagement.enterTextInUserNameSearchField(
				objUser_data.strNewUserName).selectOptionInLocationDropDown(
				objLocations_data.strfacilityname);
		Thread.sleep(2000);
		objUserManagement.clickOnSearch().verUserWithLocation(
				objUser_data.strNewUserName, objLocations_data.strfacilityname);
		objHome.clickOnLogOut92();
