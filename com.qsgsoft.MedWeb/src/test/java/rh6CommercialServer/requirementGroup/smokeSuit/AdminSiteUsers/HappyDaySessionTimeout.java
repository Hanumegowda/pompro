package rh6CommercialServer.requirementGroup.smokeSuit.AdminSiteUsers;
...
public class HappyDaySessionTimeout extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay152273() throws Exception {
		...
		objHome.launchApplication(objLogin_data.strAppURL1);
		objCommonFunctions.clickOnContinueToThisWebsiteLink();
		objHome.verHomePage().clickOnAdminSite1();
		objCommonFunctions.clickOnContinueToThisWebsiteLink();
		...
		/*
		 * Thread.sleep(70000); objUserManagement.clickOnAddUser();
		 ...
		 * ().verUserManagementPage(); objHome.clickOnGroups();
		 * Thread.sleep(70000); objGroups.clickOnAddGroup();
		 * objUserManagement.clickOnOkInAlertPopUp();
		 * objLogin.login(objUser_data.strNewUserName,
		 * objUser_data.strNewPassword).clickLogin();
		 * objAdministratorSite.verAdministratorSitePage
