package rhel4DiacapServer.requirementGroup.smokeSuit.UserGroups;
...
public class HappyDayGroupFilters extends TestNG_UI_EXTENSIONSForOneBrowser{
	...
	**************************************************************************************/
	...
	public void testHappyDay68036() throws Exception {
		...
		for (int i1 = 0; i1 < i; i1++) {
			objViewPatients.selModalityOption(objGroups_data.modalities[i1])
					.clickOnSearch();
	...
	**************************************************************************************/
	...
	public void testHappyDay68041() throws Exception {
		...
		objLogin.loginAsUser(objUser_data.strNewUserName,
				objUser_data.strNewPassword).clickLogin();
		objViewPatients.selModalityOption(objGroups_data.modality1)
				.clickOnSearch().clickOnSearch()
				.clickOnModifyStudyFieldsIconOfAnyStudy();
		String mainwindow = driver.getWindowHandle();
		Set<String> allwindows1 = driver.getWindowHandles();
		...
		while (itr1.hasNext()) {
			...
			if (!childwindow1.contains(mainwindow)) {
				driver.switchTo().window(childwindow1);
				objViewPatients.verModality(objGroups_data.modality1);
				driver.close();
			}
		}
		driver.switchTo().window(mainwindow);
		objViewPatients.selModalityOption(objGroups_data.modality)
				.clickOnSearch().clickOnSearch()
				.clickOnModifyStudyFieldsIconOfAnyStudy();
		...
		driver.switchTo().window(mainwindow);
		objViewPatients.selModalityOption(objGroups_data.modality2)
				.clickOnSearch().clickOnSearch()
				.clickOnModifyStudyFieldsIconOfAnyStudy();
		Set<String> allwindows21 = driver.getWindowHandles();
		Iterator<String> itr21 = allwindows21.iterator();
		while (itr21.hasNext()) {
			String childwindow1 = itr21.next().toString();
			if (!childwindow1.contains(mainwindow)) {
				driver.switchTo().window(childwindow1);
				objViewPatients.verModality(objGroups_data.modality2);
				driver.close();
			}
		}
		driver.switchTo().window(mainwindow);
	...
	**************************************************************************************/
	...
	public void testHappyDay68034() throws Exception {
		...
		objLogin.loginAsUser(objUser_data.strNewUserName,
				objUser_data.strNewPassword).clickLogin();
		objViewPatients.selLimitOption(objViewPatients_data.strLimit1)
				.clickOnSearch().clickOnSearch();
		boolean b = true;
		for (int i = 1; i <= Integer.parseInt(objViewPatients_data.strLimit1); i++) {
			if (b) {
				b = objViewPatients.clickOnModifyStudyFieldsIconOfReqStudy(i);
				Set<String> allwindows1 = driver.getWindowHandles();
				Iterator<String> itr1 = allwindows1.iterator();
				while (itr1.hasNext()) {
					String childwindow1 = itr1.next().toString();
	...
	**************************************************************************************/
	...
	public void testHappyDay166355() throws Exception {
		...
		objLogin.loginAsUser(objUser_data.strtelUserName,
				objUser_data.strNewPassword).clickLogin();
		String[] cases1 = { objUser_data.strCaseLastName1,
				objUser_data.strCaseLastName2, objUser_data.strCaseLastName3,
				objUser_data.strCaseLastName4, objUser_data.strCaseLastName5 };
		String[] cases2 = { objUser_data.strCaseFirstName1,
				objUser_data.strCaseFirstName2, objUser_data.strCaseFirstName3,
				...
				if (!element.equals(mainwindowHandle)) {
					...
					objTelemedicineService
							...
							/* .enterInsurance("abcd123") */.selDayFromDropdown(
									"").selMonthFromDropdown("")
							.selYearFromDropdown("").clickOnDataFiles();
					objTelemedicineService
		...
		objTelemedicineService.verCase(objUser_data.strCaseLastName1)
				.verCase(objUser_data.strCaseLastName2)
				.verCase(objUser_data.strCaseLastName3)
				.verCase(objUser_data.strCaseLastName4)
				.verCase(objUser_data.strCaseLastName5).clickOnLogOut();
		Thread.sleep(2000);
		objHome.clickOnViewPatients();
