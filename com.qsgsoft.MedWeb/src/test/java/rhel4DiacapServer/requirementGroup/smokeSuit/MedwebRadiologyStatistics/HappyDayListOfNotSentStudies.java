...
public class HappyDayListOfNotSentStudies extends TestNG_UI_EXTENSIONSForOneBrowser{
	public HappyDayListOfNotSentStudies() throws Exception{
		super();
	}
	
	/*************************************************************************************
    'Description   : Verify that list of studies that were received to the Medweb Server but not 
                     routed to other destination for the current day is displayed when 'Today' is 
                     selected in the 'Time Period of arrival studies' dropdown.     
    'Precondition  :
    'Date          : 19-May-2016
    'Author        : Hanumegowda
    '---------------------------------------------------------------
    ...
    'Date                                                         Name
	**************************************************************************************/
	@Test(description = "Verify that list of studies that were received to the Medweb Server but not routed"
			+ " to other destination for the current day is displayed when 'Today' is selected in the 'Time Period"
			+ "of arrival studies' dropdown.")
	public void testHappyDay69337() throws Exception {

		gstrTCID = "69337";
		gstrTO = "Verify that list of studies that were received to the Medweb Server but not routed to other "
				+ "destination for the current day is displayed when 'Today' is selected in the 'Time Period of arrival "
				+ "studies' dropdown.";
		...
		objNavigationToSubMenus.clickOnDICOMSettings();
		objDICOMSetting.dePauseTheDeliveryOfNewStudiesCheckBox()
		...
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
		objStatistics.clickOnRadiology().clickOnListOfNonSentStudies()
