package rhel4DiacapServer.requirementGroup.smokeSuit.AddendumReports;
			...
			if (!childwindow.contains(mainwindowhandle)) {
				...
				while (ite11.hasNext()) {
					...
					if ((!childwindow11.contains(mainwindowhandle))
						 ...
						 */
						.clickOnSaveAndSignAddendum().clickOnSignReport();
			...
			if (!childwindow.contains(mainwindowhandle)) {
				...
				while (ite11.hasNext()) {
					...
					if ((!childwindow11.contains(mainwindowhandle))
							&& (!childwindow11.contains(childwindow))) {
						driver.switchTo().window(childwindow11);
						objViewPatients.enterTextInSendToFieldInEditReportPage(
