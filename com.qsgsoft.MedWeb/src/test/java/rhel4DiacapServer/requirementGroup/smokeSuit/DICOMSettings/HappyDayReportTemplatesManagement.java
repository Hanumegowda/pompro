	...
	**************************************************************************************/
	...
	public void testHappyDay122429() throws Exception {
		...
		String backupfiledownloadpath = backfile + "\\"
				+ objViewPatients_data.strFile + ".xml";
		String filepath = backfile + "\\" + objViewPatients_data.strFile
				+ ".zip";
		System.out.println(backupfiledownloadpath);

		String autoit = pathProps
				.getProperty(objPathData./* autoItFilePath2 */strAutoITPath2);
		...
		objFileFormatConverter.convertXmlToZip(backupfiledownloadpath,
				filepath, objViewPatients_data.strFile + ".xml");
		Thread.sleep(5000);
		...
		objReportTemplatesManagement
				.enterTextInTemplateNameTextField(
						objViewPatients_data.strTemplate).clickOnStartSearch()
				.verATemplateIsPresent(objViewPatients_data.strTemplate);
		objHome.clickOnLogOut();
