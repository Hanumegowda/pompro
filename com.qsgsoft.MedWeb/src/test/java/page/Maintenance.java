...
public class Maintenance extends PageObject{
	...
	static String transport = "//select[@name='TRANSPORT_TYPE']",
			      ...
			      restore1 = "//img[@src='/.cobalt/images/a_top_maint_restore.gif']",
			      ...
			      enableScheduledBackups = "SCHEDULE_ENABLED";
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public Maintenance clickOnRestoreButton1()
			throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame().switchToSubMenuInRightFrame();
		objWaitForElement.waitForElements(restore1, "xpath");
		this.page.element(restore1, "xpath").getOne().click();
		return this;
	}
	...
	**********************************************************************************/
	...
	/**********************************************************************************
	* Description : This function is to deselect 'Enable Scheduled Backups' checkbox.
	* Date 		  : 11-Jan-2017
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public Maintenance deSelEnableScheduledBackupsCheckBox()
			throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame().switchToMainInRightFrame();
		objWaitForElement.waitForElements(enableScheduledBackups, "name");
		if(this.page.element(enableScheduledBackups, "name").getOne().isSelected()==true){
			this.page.element(enableScheduledBackups, "name").getOne().click();
		}
		return this;
	}
