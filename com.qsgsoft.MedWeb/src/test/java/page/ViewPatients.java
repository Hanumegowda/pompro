...
public class ViewPatients extends PageObject{
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public ViewPatients verUploadZipFile1(String file) throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
		.switchToMainInRightFrame();
		objWaitForElement.waitForElements("//th[text()='Name']/../..//a[contains(text(),'"+file+"')]", "xpath");
		assertTrue(this.page.element("//th[text()='Name']/../..//a[contains(text(),'"+file+"')]", "xpath").getOne().isDisplayed());
		return this;
	}
...
//				+ "('Click here to send this study to DICOM storage device, to printer or recipient by e-mail/e-fax'); return true;\"]";
	...
	**********************************************************************************/
	...
	/**********************************************************************************
	* Description : This function is to verify 'Site' in view patient page that have particular project.
	* Date 		  : 09-Sep-2015
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public ViewPatients verProjectStudyName(String strmtf) throws Exception {
		String str = "//img[@src='/cobalt-images/modify.gif']/ancestor::td[1]/preceding-sibling::td//a[2]";
		objWaitForElement.waitForElements(str, "xpath");
		int i=1;
		List<WebElement> ae = driver.findElements(By.xpath(str));
		for (WebElement ee : ae) {
			String str1 = ee.getText();
			assertTrue(str1.contains(strmtf));
	...
	**********************************************************************************/
	public ViewPatients delAllSelectedStudiesWithoutSecurityLink() throws Exception {
		...
		while (itr.hasNext()) {
			...
			if (!childwindow.contains(mainWindow)) {
				driver.switchTo().window(childwindow);
				if((driver.getCurrentUrl()).contains("172.16.27.92")){
	...
	**********************************************************************************/
	public ViewPatients delAPerticularStudy(String strstudy) throws Exception {
		...
		while (itr.hasNext()) {
			...
			if (!childwindow.contains(mainWindow)) {
				driver.switchTo().window(childwindow);
				if((this.driver.getCurrentUrl()).contains("172.16.27.92")){
					objCommonFunctions.clickOnContinueToThisWebsiteLink();
				}
//				objWaitForElement.waitForElements(continueToThisWebsite, "xpath");
//				this.page.element(continueToThisWebsite, "xpath").getOne().click();
	...
	**********************************************************************************/
	...
	/**********************************************************************************
	* Description : This function is to click On 'modify study fields' icon of required study.
	* Date 		  : 19-Oct-2015
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public boolean clickOnModifyStudyFieldsIconOfReqStudy(int i) throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
		.switchToMainInRightFrame();
		String str = "(//img[@src='/cobalt-images/modify.gif'])["+i+"]";
		objWaitForElement.waitForElements(str, "xpath");
	...
	**********************************************************************************/
	...
	/**********************************************************************************
	* Description : This function is to verify fake data of incoming study (ie patient name,patient id and site).
	* Date 		  : 03-Nov-2015
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public ViewPatients verFakeDataOfStudy(String time) throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame().switchToMainInRightFrame();
		String str = "//nobr[contains(text(),'Site:')]/b[text()='DEMO']/ancestor::tr[2]/following-sibling::tr[1]//td//a[contains(text(),'DN_')]/../following-sibling::td[contains(text(),'DP')]/following-sibling::td[text()='"+time+"']";
		objWaitForElement.waitForElements(str, "xpath");
		assertTrue(this.page.element(str, "xpath").isElementPresent());
		return this;
	}
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public String getTimeOfAStudy(String study) throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame().switchToMainInRightFrame();
		String str = "//th[8][text()='Time']/../following-sibling::tr//td/a[contains(text(),'"+study+"')]/../../td[8]";
		objWaitForElement.waitForElements(str, "xpath");
		String time = this.page.element(str, "xpath").getOne().getText();
		return time;
	}
	...
	**********************************************************************************/
	public ViewPatients enterTextInSendToFieldInEditReportPage(String mailid) throws Exception {
		//objFrames.switchToForm("FRM");
		/*objWaitForElement.waitForElements(sendTo1, "xpath");
		this.page.element(sendTo1, "xpath").clearInputValue().sendKeys(mailid);*/
		objWaitForElement.waitForElements("//form[@name='FRM']//table[@id='maintable']//div[@id='oReportButton']//td/input[@id='mail_to']", "xpath");
		this.page.element("//form[@name='FRM']//table[@id='maintable']//div[@id='oReportButton']//td/input[@id='mail_to']", "xpath").clearInputValue().sendKeys(mailid);
		return this;
	}
   ...
   **********************************************************************************/
	...
	public ViewPatients enterTextInReportEditorPage(String text)
		...
		String str2 = "//td/b[contains(text(),'Patient')]/..//following-sibling::td";
	...
	public ViewPatients enterTextInReportEditorPage1(String text)
		...
		//String str4 = "//td/b[contains(text(),'PATIENT NAME')]/..//following-sibling::td";
		String str4 ="//div[@id='oDiv']//table[@id='mark']//td/b[contains(text(),'PATIENT NAME')]/..//following-sibling::td";
	...
	**********************************************************************************/
	...
	public ViewPatients clickOnAddIconInEditorPropertiesPage() throws Exception {
		objFrames.switchToDefaultFrame().switchToIFrame("oFrame0");
		objWaitForElement
				.waitForElements(
