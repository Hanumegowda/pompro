...
public class SystemStatus extends PageObject{
	...
	private String memoryStatus = "//b[text()='Memory Status']",
			       ...
			       cpu1 = "//img[@src='/.cobalt/images/a_top_system_cpu.gif']",
			       cpu = "//a[text()='CPU']",
			       cpuUsage = "//b[contains(text(),'CPU Usage')]",
			       loadGraph = "//td[@class='legendLabel']",
			       disk = "//a[text()='Disk']",
			       disk1 = "//img[@src='/.cobalt/images/a_top_system_disk.gif']",
			       ...
			       network1 = "//img[@src='/.cobalt/images/a_top_system_network.gif']",
			       ...
			       uptime = "//a[text()='Uptime']",
			       uptime1 = "//img[@src='/.cobalt/images/a_top_uptime.gif']",
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public SystemStatus clickOnCPU1() throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
				.switchToSubMenuInRightFrame();
		objWaitForElement.waitForElements(cpu1, "xpath");
		this.page.element(cpu1, "xpath").getOne().click();
		return this;
	}
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public SystemStatus clickOnDisk1() throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
				.switchToSubMenuInRightFrame();
		objWaitForElement.waitForElements(disk1, "xpath");
		this.page.element(disk1, "xpath").getOne().click();
		return this;
	}
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public SystemStatus clickOnNetwork1() throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
				.switchToSubMenuInRightFrame();
	...
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public SystemStatus clickOnUptime1() throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
				.switchToSubMenuInRightFrame();
		objWaitForElement.waitForElements(uptime1, "xpath");
		this.page.element(uptime1, "xpath").getOne().click();
		return this;
	}
