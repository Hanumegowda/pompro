...
public class PatientScheduleRegistration extends PageObject{
	...
	private String patientRegistration = "//td[contains(text(),'Patient Registration')]",
			       ...
			       reasonForStudySearchIcon = "//font[text()='Reason for Study']/..//img[@src='/wavelet/gifs.new/ris_search_icon.gif']",
			       addReason = "//img[@src='/wavelet/mini-ris/html_editor/images/smallest_plus_but.gif']",
			       reason = "reason",
...
//				.switchToMainInRightFrame();
	...
	**********************************************************************************/
	...
	/**********************************************************************************
	* Description : This function is to click on search icon of 'Reason for Study' in 'enter order' page.
	* Date 		  : 16-Dec-2016
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public PatientScheduleRegistration clickOnSearchIconOfReasonForStudy()
			throws Exception {
		objFrames.switchToDefaultFrame().switchToRightFrame()
				.switchToMainInRightFrame();
		objWaitForElement.waitForElements(reasonForStudySearchIcon, "xpath");
		this.page.element(reasonForStudySearchIcon, "xpath").getOne().click();
				
		return this;
	}
	
	/**********************************************************************************
	* Description : This function is to click on add(+) icon of 'Reason for Study' in 'Reason For Study' page.
	* Date 		  : 16-Dec-2016
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public PatientScheduleRegistration clickOnAddIconInReasonForStudyPage()
			throws Exception {
		objWaitForElement.waitForElements(addReason, "xpath");
		this.page.element(addReason, "xpath").getOne().click();
				
		return this;
	}
	
	/**********************************************************************************
	* Description : This function is to enter the reason in 'Reason For Study' page.
	* Date 		  : 16-Dec-2016
	* Author 	  : Hanumegowda
	**********************************************************************************/
	public PatientScheduleRegistration enterReasonInReasonForStudyPage(String str)
			throws Exception {
		objWaitForElement.waitForElements(reason, "name");
		this.page.element(reason, "name").getOne().sendKeys(str);
