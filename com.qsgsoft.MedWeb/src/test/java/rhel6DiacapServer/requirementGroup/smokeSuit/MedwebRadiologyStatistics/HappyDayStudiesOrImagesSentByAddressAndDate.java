	...
	**************************************************************************************/
	...
	public void testHappyDay69322() throws Exception {
		...
		objLogin.loginAsUser(objLogin_data.strAdminUser,
				objLogin_data.strAdminUserPwd).clickLogin();
		objStatistics.clickOnRadiology().clickOnStudiesImagesSentByAddressAndDate()
				.selDoctor(objDICOMSettings_data.aETitle1).clickOnNext()
				.clickOnNext1();
		int actual = objStatistics
				.getStatisticsCountOfParticularModality(objDICOMSettings_data.aETitle1);
		...
		objStatistics
				...
				.selDoctor(objDICOMSettings_data.aETitle1)
				.clickOnNext()
				.clickOnNext1()
				.verStudyReceivedByDifferentStatistics(
						objDICOMSettings_data.aETitle1, actual);
