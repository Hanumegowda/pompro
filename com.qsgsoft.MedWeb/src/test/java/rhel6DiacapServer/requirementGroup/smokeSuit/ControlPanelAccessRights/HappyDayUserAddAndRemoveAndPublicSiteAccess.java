package rhel6DiacapServer.requirementGroup.smokeSuit.ControlPanelAccessRights;
	...
	**************************************************************************************/
	...
	public void testHappyDay68251() throws Exception {
		...
		objUserManagement.verifyUserWithRedBallandUserNeverLoggedIn(
				objUser_data.strNewUserName).clickOnModifyUser(
		...
		try {
			...
			objUserManagement
					.verifyUserWithRedBallandUserNeverLoggedInIsNotDisplayed(objUser_data.strModNewUserName);
		}
