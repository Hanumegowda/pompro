...
public class HappyDayDeleteRegionInterfaceOfTypeGetActiveEvents extends TestNG_UI_EXTENSIONS{

	public HappyDayDeleteRegionInterfaceOfTypeGetActiveEvents()
			throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	/*************************************************************************************************
	'Description : Verify that a region interface of type 'Get Active Events' can be deleted.
	'Date	 	 : 01-Oct-2015
	'Author		 : Anitha
	'-------------------------------------------------------------------------------------------------
	...
	'Date					                                                            Name
	**************************************************************************************************/
	@Test(description = "Verify that a region interface of type 'Get Active Events' can be deleted.")
	public void testHappyDay129481() throws Exception {

		gstrTCID ="129481";
		gstrTO = "Verify that a region interface of type 'Get Active Events' can be deleted."; 
