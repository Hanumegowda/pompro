...
public class HappyDayReceiveExpiredStatusNotificationsFortextstatusType extends TestNG_UI_EXTENSIONS {

	public HappyDayReceiveExpiredStatusNotificationsFortextstatusType() throws Exception {
		super();
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that user receives the following when the text status of a resource expires at the EXPIRATION time:"
							+"1. Status update prompt."
							+"2. Expired status notification")
	public void testHappyDay69018() throws Exception {
		...
		String[] strAllStatausTypes = { objStatusTypes_data.strTSTStatusTypeName };
...
//				.verViewInList(objView_data.strViewName);
		...
		objUpdateStatus1
				...
				.enterNSTAndTSTUpdateValue(strStatusTypeValues[0],
						objView_data.strValueForTST1).clickOnSaveButton();
	...
	/*************************************************************************************
	'Description :  Verify that user receives the following when the text  status of a resource expires at the SHIFT time:"
							+"1. Status update prompt."
							+"2. Expired status notification
	'Precondition:
	'Date	 	 : 25-May-2015
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = " Verify that user receives the following when the text  status of a resource expires at the SHIFT time:"
			+ "1. Status update prompt." + "2. Expired status notification")
	public void testHappyDay69020() throws Exception {

		gstrTCID = "69020";
		gstrTO = " Verify that user receives the following when the text  status of a resource expires at the SHIFT time:"
				+ "1. Status update prompt." + "2. Expired status notification";
...
//				.verViewInList(objView_data.strViewName);
		...
		String strSubject1 = "EMResource Expired Status: "
				+ objResource_data.strResourceAbbrivation;
