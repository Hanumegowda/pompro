...
public class NewHappyDayEditTextStatusType extends TestNG_UI_EXTENSIONS {

	public NewHappyDayEditTextStatusType() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	/*************************************************************************************
	'Description : Verify that a text status type can be edited.
	'Precondition:
	'Date	 	 : 19-May-2015
	'Author		 : Pallavi
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that a text status type can be edited.")
	public void testHappyDay98904() throws Exception {
...
//					.clickOnSaveOfCreateNewView();
		...
		objViewsList1.verifyNameAndDefinitionOnDefnScreen(objStatusTypes_data.strTSTStatusTypeName,
	 			objStatusTypes_data.strStatusDescription);
		...
		objUpdateStatus1.verifyStatusNameAndDefinitionUpdateStatusScreen(
							strStatusTypeValues[0], objStatusTypes_data.strTSTStatusTypeName,
							objStatusTypes_data.strStatusDescription)
		...
		objStatusTypeList1
				.clickOnEditOfStatusType(
						objStatusTypes_data.strTSTStatusTypeName)
				.enterStatusTypeName(
						"Edt" + objStatusTypes_data.strTSTStatusTypeName)
				.enterStatusTypeDescription(
						"Edt" + objStatusTypes_data.strStatusDescription)
				.clickOnSaveButton();

		System.out.println("Edt" + objStatusTypes_data.strTSTStatusTypeName);
		...
		String[] arrStatusTypeName = { "Edt" + objStatusTypes_data.strTSTStatusTypeName };
		...
		objViewsList1.verifyNameAndDefinitionOnDefnScreen("Edt" + objStatusTypes_data.strTSTStatusTypeName,
										objStatusTypes_data.strStatusDescription);
		...
		objViewsList1.clickOnResourceAndNavigateToResourceDetail(objResource_data.strResourceName)
					 .verifyStatusTypeUnderSectionsInResourceDetailPage("Edt" + objStatusTypes_data.strTSTStatusTypeName,
							 	objView_data.strSectionName);
