...
public class InactivateResourceType extends TestNG_UI_EXTENSIONSThreeBrowser {
	public InactivateResourceType() throws Exception {
		super();
	}
	...
	public void testHappyDay69811() throws Exception {
...
//				.clickOnSaveOfCreateNewView();
		...
		objStatusTypeList2.selectInactiveResourceTypesCheckBox();
		objStatusTypeList2
				.clickOnEditOfResourceType(
						objResourceType_data.strResourceTypeName)
				.deselectActiveCheckBox().clickOnSaveButton();
		...
		Thread.sleep(2000);
// EMS-8239 - Reactivated Resource type does not appear on ‘Other Region’ view screen on refresh.
		
		objNavigationToSubmenus1
		.navigateToRegUnderOtherRegions(objLogindata.strStateWideReg);//modified
