...
public class HappyDayEditRegionInterfaceOfTypePostResourceDetailStatus extends TestNG_UI_EXTENSIONS {

	public HappyDayEditRegionInterfaceOfTypePostResourceDetailStatus()
			throws Exception {
		super();
	...
	/****************************************************************************************************************
	'Description :  Verify that a region interface of type 'Post Resource Detail Status' can be edited.
	'Date	 	 : 03-Jun-2015
	'Author		 : Sangappa.k
	'----------------------------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	*****************************************************************************************************************/
	@Test(/*invocationCount=3,*/description = "Verify that a region interface of type 'Post Resource Detail Status' can be edited.")
	public void testHappyDay101823() throws Exception {
