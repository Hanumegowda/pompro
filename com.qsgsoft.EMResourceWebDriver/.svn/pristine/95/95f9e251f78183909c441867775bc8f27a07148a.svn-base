...
public class NewHappyDayReceiveExpiredStatusNotificationsForSaturationScoreStatusType extends TestNG_UI_EXTENSIONS {

	public NewHappyDayReceiveExpiredStatusNotificationsForSaturationScoreStatusType()
			throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	/*************************************************************************************
	'Description : Verify that user receives the following when the text status of a resource expires at the EXPIRATION time:
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that user receives the following when the saturation score status of a resource expires at the EXPIRATION time: "
							+"1. Status update prompt."
							+"2. Expired status notification")
	public void testHappyDay69017() throws Exception {
		...
		String[] strAllStatausTypes = { objStatusTypes_data.strSSTStatusTypeName };
...
//				.verViewInList(objView_data.strViewName);
	...
	/*************************************************************************************
	'Description : Verify that user receives the following when the saturation score status of a resource expires at the SHIFT time:
					1. Status update prompt.
					2. Expired status notification 
	'Precondition:
	'Date	 	 : 27-May-2015
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that user receives the following when the saturation score status of a resource expires at the SHIFT time:"
			+ "1. Status update prompt."
			+ "2. Expired status notification ")
	public void testHappyDay69019() throws Exception {

		gstrTCID = "69019";
		gstrTO = "Verify that user receives the following when the saturation score status of a resource expires at the SHIFT time:"
				+ "1. Status update prompt." 
				+ "2. Expired status notification ";
...
Thread.sleep(20000);
		...
		assertTrue(blnMsg2);assertTrue(blnMsg1);
