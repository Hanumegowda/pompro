...
public class HappydayCreateDateStatusTypes extends TestNG_UI_EXTENSIONS{

	
	public HappydayCreateDateStatusTypes() throws Exception {
		super();
	...
	@Test(description = " Verify that user can create Date status type.")
	public void testHappyDay145759() throws Exception {
		gstrTCID = "145759";
		gstrTO = "Verify that user can create Date status type.";
		...
		ResourceType_page1.verifyStatusTypeIsListed(strStatusTypeValues);
