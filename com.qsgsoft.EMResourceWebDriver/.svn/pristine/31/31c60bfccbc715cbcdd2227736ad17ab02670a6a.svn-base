...
public class NewInactivateResourcetype extends TestNG_UI_EXTENSIONSThreeBrowser {
	
	public NewInactivateResourcetype() throws Exception {
		super();
	}

	/*************************************************************************************
	 * 'Description 	:  Verify that user can deactivate a resource type displayed in the Other Region view.
	 * 'Precondition	: 
	 * 'Date 			: 24-Mar-2015 
	 * 'Author 			: Anil
	 * '---------------------------------------------------------------
	 ...
	 * 'Date Name
	 **************************************************************************************/
	@Test(description = " Verify that user can deactivate a resource type displayed in the Other Region view.")
	public void testHappyDay69778() throws Exception {
		...
		NavigationToSubMenus objNavigationToSubmenus2 = new NavigationToSubMenus(
				this.driver2);
		ResourceType objResourceType2 = new ResourceType(this.driver2);
...
//		}
		...
		objNavigationToSubmenus2.navigateToResourceTypesInSetup();
		
		objResourceType2.clickOnEditLinkOfResourceType(objResourceType_data.strResourceTypeName);
		
		objResourceType2.deselectActiveCheckBox()
		...
		objViews1.verResourceTypeAndResourceName1(
				objResourceType_data.strResourceTypeName,
				objResource_data.strResourceName);
