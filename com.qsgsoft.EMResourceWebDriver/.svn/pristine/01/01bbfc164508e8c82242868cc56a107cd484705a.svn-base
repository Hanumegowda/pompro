...
public class HappyDayEditRegionInterfaceOfTypeGetCADStatus extends TestNG_UI_EXTENSIONS {
	public HappyDayEditRegionInterfaceOfTypeGetCADStatus() throws Exception {
		super();
	}
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = " Verify that a region interface of type 'Get CAD Status' can be edited.")
	public void testHappyDay101822() throws Exception {
		...
		objInterfacesInSetUp1.verifyCreatedInterfaceInList(
				objInterfaceInSetUp_data.strInterfaceName1,
				objInterfaceInSetUp_data.strInterfaceDesc1,
				objInterfaceInSetUp_data.strInterfaceType3, strWebServAction1,
				objInterfaceInSetUp_data.strInterfaceActiveStatus);
		objInterfacesInSetUp1
