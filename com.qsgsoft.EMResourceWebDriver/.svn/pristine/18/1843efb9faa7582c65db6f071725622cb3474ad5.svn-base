...
public class HappyDayEditForm extends TestNG_UI_EXTENSIONS{

	public HappyDayEditForm() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	/************************************************************************************************************
	'Description :  Verify that form title can be edited only from EMResource.(Not from 'Template Designer' page)
	'Precondition:
	'Date	 	 : 23-Dec-2014
	'Author		 : Pallavi
	'------------------------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	*************************************************************************************************************/
	@Test(description = " Verify that form title can be edited only from EMResource.(Not from 'Template Designer' page).")
	public void testHappyDay152088() throws Exception {

		gstrTCID = "152088";
		gstrTO = " Verify that form title can be edited only from EMResource.(Not from 'Template Designer' page).";
		...
		objFormConfiguration
				...
				.entireTittleName(objFormConfiguration_data.strFormName1)
...
//				+ objBlankFormData.strNumericAnswer + "";
		...
		objRegionDefault1
				...
				.verWebNotificationMsgForForms(objFormConfiguration_data.strFormName1,
		...
		String strSubject = objFormConfiguration_data.strFormName1;
	...
	/*************************************************************************************
	'Description : Edit a V3 form and change the activation and completed form delivery choices and verify that the updated configuration is updated
	'Precondition:
	'Date	 	 : 22-Dec-2014
	'Author		 : Anil
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Edit a V3 form and change the activation and completed form delivery choices and verify that the updated configuration is updated")
	public void testHappyDay149518() throws Exception {

		gstrTCID = "149518";
		gstrTO = "Edit a V3 form and change the activation and completed form delivery choices and verify that the updated configuration is updated";
...
//				.clickSaveButton();
		...
		objFormConfiguration1.selectOptionInFormActivationDropDown(
...
//				+ objBlankFormData.strNumericAnswer + "| "+objFormConfiguration_data.strLabelName1+": "+objBlankFormData.strTextAnswer;
		...
		String strMsg = objRegionDefault1
				.getWebNotificationForTwoQuestionnaire(objUserdata.strFullName1,
						objLogindata.strRegionName,
						objFormConfiguration_data.strLabelName,
						objBlankFormData.strNumericAnswer,
...
//				.selectFrame();
	...
	/************************************************************************************************************
	'Description : Verify that edited form title is reflected in all form activities. 
	'Precondition:
	'Date	 	 : 05-Jan-2015
	'Author		 : Renushree
	'------------------------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	*************************************************************************************************************/
	@Test(description = "Verify that edited form title is reflected in all form activities. ")
	public void testHappyDay152208() throws Exception {

		gstrTCID = "152208";
		gstrTO = "Verify that edited form title is reflected in all form activities. ";
		...
		objActivateForms1
				.clickOnSendForm(objFormConfiguration_data.strFormName1)
				.selUserToFillOutForm(objUserdata.strNewUserName)
				.clickOnActivateForm();
		...
		objBlankForm
				.verFormTitle(objFormConfiguration_data.strFormName1)
				.verGroupName(objFormConfiguration_data.strGroupName)
				.verFieldSetName(objFormConfiguration_data.strAttributeName)
...
//				+ ": " + objBlankFormData.strNumericAnswer + "";
		...
		objRegionDefault1
				...
				.verWebNotificationMsgForForms(
						objFormConfiguration_data.strFormName1, strMsg)
		...
		objReport1.clickOnFormDetail().verifyFormDetailReportPage()
				...
				.selForm(objFormConfiguration_data.strFormName1);
		...
		objReport1
				.verifyFormNameStartDateAndEndDate(
						objFormConfiguration_data.strFormName1, strStartDate,
		...
		String[] arrForm = { "Form", objFormConfiguration_data.strFormName1 };
	...
	/*********************************************************************************************
	'Description : Verify that user can edit the New form to deselect the 'Read receipt' check box
	'Date	 	 : 06-March-2015
	'Author		 : Anil
	'-----------------------------------------------------------------------------------------------
	'Modified Date			                        	                   Modified By
	'Date					                                               Name
	************************************************************************************************/
	@Test(description = " Verify that user can edit the New form to deselect the 'Read receipt' check box.")
	public void testHappyDay119611() throws Exception {

		gstrTCID = "119611";
		gstrTO = "Verify that user can edit the New form to deselect the 'Read receipt' check box.";
		...
		objFormConfiguration
				...
				.selectCompletedFormDelivery(objFormConfiguration_data.strUserToIndividualUsers)
				.selHowToNotify(objFormConfiguration_data.strNotifyViaWeb)
				.selHowToNotify(objFormConfiguration_data.strNotifyViaEmail)
				.selHowToNotify(objFormConfiguration_data.strNotifyViaPager)
				.selReadReceipt()
				.clickOnNextButton()
				.deSelectAllUsersCheckBox()
				.selUserToRcvCompltdForm(objUserdata.strNewUserName)
				.clickOnNextButton()
				.selectActivateFormChkBox(objUserdata.strNewUserName1)
				.clickOnSaveOfFormSecuritySetting();
...
//						+ ": " + objBlankFormData.strNumericAnswer;
		...
		boolean blnMsg1 = false, blnMsg2 = false, blnMsg3 = false;
	...
	/*************************************************************************************************************
	'Description : Verify that an New form can be edited.
	'Precondition:
	'Date	 	 : 20-Mar-2015
	'Author		 : Renushree
	'------------------------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	*************************************************************************************************************/
	@Test( description = "Verify that an New form can be edited.")
	public void testHappyDay69635() throws Exception {

		gstrTCID = "69635";
		gstrTO = "Verify that an New form can be edited.";
