...
public class HappyDayEditRegionInterfaceOfTypeGetHospitalStatus extends TestNG_UI_EXTENSIONS {

	public HappyDayEditRegionInterfaceOfTypeGetHospitalStatus()
			throws Exception {
		super();
	...
	'Date					                                                                Name
	*****************************************************************************************************************/
	@Test(/*invocationCount=3,*/description = " Verify that a region interface of type 'Get Hospital Status' can be edited.")
	public void testHappyDay101821() throws Exception {
