...
public class HappyDayEditRegionInterfaceOfTypeUpdateCADStatus extends TestNG_UI_EXTENSIONS {
	public HappyDayEditRegionInterfaceOfTypeUpdateCADStatus() throws Exception {
		super();
	}
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = " Verify that a region interface of type 'Update CAD Status' can be edited.")
	public void testHappyDay94126() throws Exception {
		...
		objInterfacesInSetUp1.verifyCreatedInterfaceInList(
				objInterfaceInSetUp_data.strInterfaceName1,
				objInterfaceInSetUp_data.strInterfaceDesc1,
				objInterfaceInSetUp_data.strInterfaceType11, strWebServAction1,
				objInterfaceInSetUp_data.strInterfaceActiveStatus);
		objInterfacesInSetUp1
