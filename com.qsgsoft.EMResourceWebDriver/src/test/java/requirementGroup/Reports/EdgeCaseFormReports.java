...
public class EdgeCaseFormReports extends TestNG_UI_EXTENSIONS {

	public EdgeCaseFormReports() throws Exception {
		super();
	}

	/************************************************************************************************************
	'Description : Verify that message stating 'No forms were found in the specified time frame.' is displayed when 
	               attempted generate 'Form Detail' report for the form that is not activated.  
	'Precondition:
	'Date	 	 : 26-Feb-2015
	'Author		 : Hanumegowda
	'------------------------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	*************************************************************************************************************/
	@Test(enabled = false,description = " Verify that message stating 'No forms were found in the specified time frame.' is displayed when "
			+ "attempted generate 'Form Detail' report for the form that is not activated.")
	public void testEdgeCase152075() throws Exception {
		...
		String strCurrentDate = objDts.timeNow("MM/dd/yyyy");
		...
		objReport1
				.verifyFormNameStartDateAndEndDate(
						objFormConfiguration_data.strFormName, strCurrentDate,
						strCurrentDate).verNoformsfoundinspecifieddaterangeErrMsgInHtml();
	...
	/**************************************************************************
	'Description : Verify that admin user cannot generate 'Form Detail Report'.
	'Date	 	 : 31-Mar-2015
	'Author		 : Anitha
	'--------------------------------------------------------------------------
	'Modified Date			                              Modified By
	'Date					                              Name
	***************************************************************************/
	@Test(description = "Verify that admin user cannot generate 'Form Detail Report'.")
	public void testEdgeCase152346() throws Exception {

		gstrTCID = "152346";
		gstrTO = "Verify that admin user cannot generate 'Form Detail Report'.";
	...
	/*************************************************************************************
	'Description : Verify that (delete) suffix is displayed corresponding to deleted form questionnaire in the form detail report. 
	'Precondition:
	'Date	 	 : 31-Mar-2015
	'Author		 : Anil
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that (delete) suffix is displayed corresponding to deleted form questionnaire in the form detail report. ")
	public void testEdgecase153305() throws Exception {

		gstrTCID = "153305";
		gstrTO = "Verify that (delete) suffix is displayed corresponding to deleted form questionnaire in the form detail report. ";
...
//						+ objBlankFormData.strNumericAnswer;
		...
		String[] strQuestions = { objFormConfiguration_data.strLabelName1, objFormConfiguration_data.strLabelName+" (Deleted)"};
	...
	/*************************************************************************************
	'Description : Verify that appropriate form Title, start date and end date are displayed 
				   in Form Detail Report XLSX format.
	'Precondition:
	'Date	 	 : 31-Mar-2015
	'Author		 : Pallavi
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that appropriate form Title, start date and end date are displayed in Form Detail Report XLSX format.")
	public void testEdgeCase152332() throws Exception {

		gstrTCID = "152332";
		gstrTO = "Verify that appropriate form Title, start date and end date are displayed in Form Detail Report XLSX format.";
...
//						+ objBlankFormData.strNumericAnswer;
	...
	/*************************************************************************************
	 * 'Description : Verify that 'Report' button is not available on 'Template Designer' page. 
	 *   'Date      : 31-Mar-2015 
	 *   'Author    : Hanumegowda
	 * '---------------------------------------------------------------
	 * 'Modified Date Modified By 'Date Name
	 **************************************************************************************/
	@Test(description = "Verify that 'Report' button is not available on 'Template Designer' page.")
	public void testEdgeCase151194() throws Exception {

		gstrTCID = "151194";
		gstrTO = "Verify that 'Report' button is not available on 'Template Designer' page.";
		...
		objFormConfiguration1
				...
				.clickOnDoneButton()
				.clickOnSaveButton();
		objFormConfiguration1.verReportButton();
	...
	/*************************************************************************************
	'Description : Verify that appropriate form Title, start date and end date are displayed in Form Detail Report HTML format. 
	'Precondition:
	'Date	 	 : 31-Mar-2015
	'Author		 : Renushree
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that appropriate form Title, start date and end date are displayed in Form Detail Report HTML format. ")
	public void testEdgeCase152331() throws Exception {

		gstrTCID = "152331";
		gstrTO = "Verify that appropriate form Title, start date and end date are displayed in Form Detail Report HTML format. ";
...
//				+ objBlankFormData.strNumericAnswer;
	...
	/******************************************************************************************
	'Description : Verify that boolean value is displayed properly in the generated form report
	'Date	 	 : 31-Mar-2015
	'Author		 : Pallavi
	'------------------------------------------------------------------------------------------
	'Modified Date			                        	         Modified By
	'Date					                                     Name
	*******************************************************************************************/
	@Test(description = "Verify that boolean value is displayed properly in the generated form report.")
	public void testEdgeCase155259() throws Exception {

		gstrTCID = "155259";
		gstrTO = "Verify that boolean value is displayed properly in the generated form report.";
...
//				+ objBlankFormData.strBooleanAnswer + "";
		...
		objRegionDefault1.selectFrame()
		              	 .verWebNotificationframe()
		                 .verWebNotificationMsgForForms(objFormConfiguration_data.strFormName,strMsg)
						 .clickAcknowledgeAllForms()
						 .switchToDefaultFrame()
						 .selectFrame();
	...
	/*************************************************************************************
	'Description : Verify that report rights name is renamed from 'Report: Form Detail' to 'Report: Form Reports' 
	'Precondition:
	'Date	 	 : 11-May-2015
	'Author		 : Renushree
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that report rights name is renamed from 'Report: Form Detail' to 'Report: Form Reports'")
	public void testEdgeCase160039() throws Exception {

		gstrTCID = "160039";
		gstrTO = "Verify that report rights name is renamed from 'Report: Form Detail' to 'Report: Form Reports'";
		...
		objUsersList1
				...
				.enterUserDetails(objUserdata.strNewUserName,
						objUserdata.strNewPassword, objUserdata.strFullName).selectFirstRole()
				.clickAdvancedOptionAndExpand()
				.verReportFormDetailRightNotPresent()
				.verReportFormReportsRightPresent().clickSaveButton();
