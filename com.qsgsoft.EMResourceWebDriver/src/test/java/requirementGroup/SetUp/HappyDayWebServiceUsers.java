...
public class HappyDayWebServiceUsers extends TestNG_UI_EXTENSIONS{

	public HappyDayWebServiceUsers() throws Exception 
	{
		super();
	}
		...
		*****************************************************************************************************************/
		...
		public void testHappyDay164556() throws Exception {
	...
	public void testHappyDay164557() throws Exception {
		...
		objLogin1.verWebServiceAccountWarning()
	             ...
	             .verifyLoginPage();//now login page is displayed instead of region default page
		gstrResult = "PASS";
