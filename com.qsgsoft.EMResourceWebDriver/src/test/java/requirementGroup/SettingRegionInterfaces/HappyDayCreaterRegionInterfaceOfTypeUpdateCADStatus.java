...
public class HappyDayCreaterRegionInterfaceOfTypeUpdateCADStatus extends TestNG_UI_EXTENSIONS {
	public HappyDayCreaterRegionInterfaceOfTypeUpdateCADStatus() throws Exception {
		super();
	}
	
	/*************************************************************************************
	'Description : Verify that a region interface of type 'Update CAD Status' can be created.
	'Precondition:
	'Date	 	 : 03-June-2015
	'Author		 : Hanumegowda
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that a region interface of type 'Update CAD Status' can be created.")
	public void testHappyDay94125() throws Exception {
		...
		objInterfacesInSetUp
				...
				.selInterfaceType(objInterfaceInSetUp_data.strInterfaceType11)
				.clickOnNext()
				...
				.verDefaultTextInWebServicesActionField(
						objInterfaceInSetUp_data.defaultText2);
		...
		objInterfacesInSetUp
				.verInterfaceTypeAndDeleteCorrespondingInterface(objInterfaceInSetUp_data.strInterfaceType11);
