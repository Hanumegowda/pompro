...
public class HappyDayCreateRegionInterfaceOfTypeGetHospitalStatus extends TestNG_UI_EXTENSIONS {

	public HappyDayCreateRegionInterfaceOfTypeGetHospitalStatus()
			throws Exception {
		super();
	...
	'Date					                                                                Name
	*****************************************************************************************************************/
	@Test(/*invocationCount=3,*/description = "Verify that a region interface of type 'Get Hospital Status' can be created.")
	public void testHappyDay94041() throws Exception {
		...
		objInterfacesInSetUp
				...
				.selInterfaceType(objInterfaceInSetUp_data.strInterfaceType6)
				.clickOnNext()
		...
		objInterfacesInSetUp
				...
				.selActiveChkbox()
				.verOptionalStatusTypeMappingsFieldIsDisplayed()//Optional Status type mapping and Custom ST mapping are not displayed for 'Get Hospital Status'
