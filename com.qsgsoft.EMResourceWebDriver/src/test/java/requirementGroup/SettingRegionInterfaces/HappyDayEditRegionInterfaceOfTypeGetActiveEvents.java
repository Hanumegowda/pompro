...
public class HappyDayEditRegionInterfaceOfTypeGetActiveEvents extends TestNG_UI_EXTENSIONS{

	public HappyDayEditRegionInterfaceOfTypeGetActiveEvents() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	/**************************************************************************************
	'Description : Verify that a region interface of type 'Get Active Events' can be edited.
	'Date	 	 : 01-June-2015
	'Author		 : Anitha
	'--------------------------------------------------------------------------------------
	...
	'Date					                            Name
	***************************************************************************************/
	@Test(description = "Verify that a region interface of type 'Get Active Events' can be edited.")
	public void testHappyDay129485() throws Exception {

		gstrTCID = "129485";
		gstrTO = "Verify that a region interface of type 'Get Active Events' can be edited.";
