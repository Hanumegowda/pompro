...
public class HappyDayCreateRegionInterfaceOfTypeGetRegionConfiguration extends TestNG_UI_EXTENSIONS {

	public HappyDayCreateRegionInterfaceOfTypeGetRegionConfiguration()
			throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	/***********************************************************************************************
	'Description : Verify that a region interface of type 'Get Region Configuration' can be created.
	'Date	 	 : 13-Oct-2015
	'Author		 : Anitha
	'-----------------------------------------------------------------------------------------------
	...
	'Date					                                                                Name
	************************************************************************************************/
	@Test(description = "Verify that a region interface of type 'Get Region Configuration' can be created.")
	public void testHappyDay129477() throws Exception {

		gstrTCID ="129477";
		gstrTO = "Verify that a region interface of type 'Get Region Configuration' can be created."; 
		...
		objInterfacesInSetUp1
				...
				.verAppropriateSchemaForInterface(
						objInterfaceInSetUp_data.strSchemaForregionalConfiguration);
