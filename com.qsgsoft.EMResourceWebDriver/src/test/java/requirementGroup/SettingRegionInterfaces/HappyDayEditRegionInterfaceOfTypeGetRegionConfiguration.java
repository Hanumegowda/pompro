...
public class HappyDayEditRegionInterfaceOfTypeGetRegionConfiguration extends TestNG_UI_EXTENSIONS{

	public HappyDayEditRegionInterfaceOfTypeGetRegionConfiguration()
			throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}
	/**********************************************************************************************
	'Description : Verify that a region interface of type 'Get Region Configuration' can be edited.
	'Date	 	 : 01-June-2015
	'Author		 : Anitha
	'---------------------------------------------------------------------------------------------
	...
	'Date					                            Name
	***********************************************************************************************/
	@Test(description = "Verify that a region interface of type 'Get Region Configuration' can be edited.")
	public void testHappyDay129479() throws Exception {

		gstrTCID = "129479";
		gstrTO = "Verify that a region interface of type 'Get Region Configuration' can be edited.";
