...
public class NewHappyDayEditMultiStatusType extends TestNG_UI_EXTENSIONS {

	public NewHappyDayEditMultiStatusType() throws Exception {
		super();
		// TODO Auto-generated constructor stub
	}

	/*************************************************************************************
	'Description : Verify that a multi status type can be edited.
	'Precondition:
	'Date	 	 : 26-May-2015
	'Author		 : Pallavi
	'---------------------------------------------------------------
	...
	'Date					                            Name
	**************************************************************************************/
	@Test(description = "Verify that a multi status type can be edited.")
	public void testHappyDay99001() throws Exception {
...
//					.clickOnSaveOfCreateNewView();
		...
		objViewsList1.verifyNameAndDefinitionOnDefnScreen(objStatusTypes_data.strMSTStatusTypeName,
	 			objStatusTypes_data.strStatusDescription);
		...
		objUpdateStatus1.verifyStatusNameAndDefinitionUpdateStatusScreen(
							strStatusTypeValues[0], objStatusTypes_data.strMSTStatusTypeName,
							objStatusTypes_data.strStatusDescription)
		...
		objStatusTypeList1
				.clickOnEditOfStatusType(
						objStatusTypes_data.strMSTStatusTypeName)
				.enterStatusTypeName(
						"Edt" + objStatusTypes_data.strMSTStatusTypeName)
				.enterStatusTypeDescription(
						"Edt" + objStatusTypes_data.strStatusDescription)
				.clickOnSaveButton();

		System.out.println("Edt" + objStatusTypes_data.strMSTStatusTypeName);
		...
		String[] arrStatusTypeName = { "Edt" + objStatusTypes_data.strMSTStatusTypeName };
		...
		objViewsList1.verifyNameAndDefinitionOnDefnScreen("Edt" + objStatusTypes_data.strMSTStatusTypeName,
										objStatusTypes_data.strStatusDescription);
		...
		objViewsList1.clickOnResourceAndNavigateToResourceDetail(objResource_data.strResourceName)
					 .verifyStatusTypeUnderSectionsInResourceDetailPage("Edt" + objStatusTypes_data.strMSTStatusTypeName,
							 	objView_data.strSectionName);
